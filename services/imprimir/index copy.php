...
if (!empty($tarjetas)) {
    foreach ($tarjetas as $tarjeta) {
        ...
        $pdf->SetTextColor($COLOR_BLANCO[0], $COLOR_BLANCO[1], $COLOR_BLANCO[2]);
        $pdf->Cell($ancho_tarjeta, 4, $datos_aliado['aliado_telefono'], 0, 1, 'C');
        $pdf->SetTextColor(0);
        ...
        // --- CÓDIGO DE BARRAS ---
        $ALTURA_BARCODE_Y = $y + $alto_tarjeta - 23;
        $alto_para_barcode = 12;
...
$pdf->Output('D', 'Tarjetas_55mm_90mm_A3_7xFila_API_JSON.pdf');